...
import com.example.android.nav.fragments.GovernmentPolicies;
import com.example.android.nav.fragments.Growth;
import com.example.android.nav.fragments.Programs;
...
public class NotificationsActivity extends AppCompatActivity {
   ...
   //     mTextMessage = (TextView) findViewById(R.id.message);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new GovernmentPolicies(), "Government Policies");
        adapter.addFragment(new Growth(), "Growth");
        adapter.addFragment(new Programs(), "Programs");
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_news:
                    startActivity(new Intent(NotificationsActivity.this, NewsActivity.class));
                    return true;
